...
function setDays() {
  ...
  for (let i = 1; i <= getDaysInMonth(); i++) {
    ...
    //Add random emojis for every day of the year
    let emojis = ["✌", "😂", "😝", "😁", "😱", "👉", "🙌", "🍻", "🔥", "🌈", "☀", "🎈", "🌹", "💄", "🎀", "⚽", "🎾", "🏁", "😡", "👿", "🐻", "🐶", "🐬", "🐟", "🍀", "👀", "🚗", "🍎", "💝", "💙", "👌", "❤", "😍", "😉", "😓", "😳", "💪", "💩", "🍸", "🔑", "💖", "🌟", "🎉", "🌺", "🎶", "👠", "🏈", "⚾", "🏆", "👽", "💀", "🐵", "🐮", "🐩", "🐎", "💣", "👃", "👂", "🍓", "💘", "💜", "👊", "💋", "😘", "😜", "😵", "🙏", "👋", "🚽", "💃", "💎", "🚀", "🌙", "🎁", "⛄", "🌊", "⛵", "🏀", "🎱", "💰", "👶", "👸", "🐰", "🐷", "🐍", "🐫", "🔫", "👄", "🚲", "🍉", "💛", "💚", "😃", "🖱️", "👽", "👾", "🌌", "🌱", "🚕", "💺", "‍🎓", "📚", "🖌️", "👪", "🎸", "🤘", "♻️", "🌿", "🚰", "🦊", "🐿️", "💰", "🎹", "💶", "💋", "📅", "🐌", "🎉", "🤓", "🎈", "🥡", "🛵", "📈", "🍔", "😋", "🏰", "🏩", "🚫", "⚽", "↪️"];
    let randomMain = Math.floor(Math.random() * emojis.length);
    let randomSecond = Math.floor(Math.random() * emojis.length - 1);

    headerChildMainIcon.textContent += emojis[randomMain];
    headerChildSecondIcon.textContent += emojis[randomSecond];
    if (emojis[randomSecond] === undefined || emojis[randomSecond] === "undefined") {
      headerChildSecondIcon.textContent = "📅";
      emojis[randomSecond] = "📅";
    }

    headerChildSecondIcon.addEventListener("mouseout", function (e) {
      e.target.textContent = emojis[randomSecond];
    });
